...
class Settings(BaseSettings):
    ...
    brevo_api_key: str = ""
    brevo_from_email: str = "Teamy <teamy.app.official@gmail.com>"
    ...
    def database_ssl_enabled(self) -> bool:
        ...
        query = url.query
        ssl_mode = str(
            query.get("ssl") or query.get("sslmode") or query.get("ssl_mode") or query.get("ssl-mode") or ""
        ).lower()
        return self.database_ssl or ssl_mode in {
            "1",
            "true",
            "yes",
            "require",
    ...
    def database_connect_args(self) -> dict[str, object]:
        ...
        ca_value = query.get("ssl_ca")
        ca_file = ca_value if isinstance(ca_value, str) else self.database_ssl_ca
