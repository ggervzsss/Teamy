...
Set `BREVO_API_KEY` and `BREVO_FROM_EMAIL` in the backend environment to enable email notifications via Brevo. Create a free account at [brevo.com](https://brevo.com), verify your sender email address under Single Sender Verification, and generate an API key.
