...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_email_verification_codes_consumed_at"), "email_verification_codes", ["consumed_at"], unique=False
    )
    op.create_index(op.f("ix_email_verification_codes_email"), "email_verification_codes", ["email"], unique=False)
    op.create_index(
        op.f("ix_email_verification_codes_expires_at"), "email_verification_codes", ["expires_at"], unique=False
    )
